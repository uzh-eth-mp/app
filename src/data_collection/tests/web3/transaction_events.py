...
from web3.contract import Contract, ContractEvents, ContractEvent, ContractFunction, ContractFunctions

from app.web3.transaction_events.types import MintFungibleEvent, MintNonFungibleEvent, BurnNonFungibleEvent, \
    TransferNonFungibleEvent, BurnFungibleEvent, TransferFungibleEvent, PairCreatedEvent, MintPairEvent, BurnPairEvent, \
    SwapPairEvent
...
class CommonTest(unittest.TestCase):
    def test_unknown_category_no_events(self):
        ...
        events = te.get_transaction_events(ContractCategory.UNKNOWN, contract, receipt, block_hash)
        events = list(events)
...
class ERC20Tests(unittest.TestCase):
    def test_erc20_mint_transfer0x000(self):
        ...
        receipt = MagicMock(spec=TxReceipt)
        receipt.__getitem__ =\
            lambda _, x: '0x000000000000000000000000000000000000AAAA' if x == 'contractAddress' else None
        block_hash = MagicMock(spec=HexBytes)

        events = te.get_transaction_events(ContractCategory.ERC20, contract, receipt, block_hash)
        events = list(events)

        self.assertEqual([MintFungibleEvent(
    ...
    def test_erc20_usdt_mint_issue(self):
        ...
        getOwner_function.call = MagicMock(return_value="0x000000000000000000000000000000000000BABA")
    ...
    def test_erc20_burn_transfer0x000(self):
        ...
        self.assertEqual([BurnFungibleEvent(
            contract_address='0x000000000000000000000000000000000000AAAA',
            account='0x000000000000000000000000000000000000BABA',
            value=42)], events)
    ...
    def test_erc20_transfer(self):
        ...
        self.assertEqual([TransferFungibleEvent(
            contract_address='0x000000000000000000000000000000000000AAAA',
...
class ERC721Tests(unittest.TestCase):
    def test_erc721_mint_transfer0x000(self):
        ...
        events = te.get_transaction_events(ContractCategory.ERC721, contract, receipt, block_hash)
        events = list(events)

        self.assertEqual([MintNonFungibleEvent(
            contract_address='0x000000000000000000000000000000000000AAAA',
            account='0x000000000000000000000000000000000000BABA',
            tokenId=4)], events)
    ...
    def test_erc721_burn_transfer0x00(self):
        ...
        self.assertEqual([BurnNonFungibleEvent(
            contract_address='0x000000000000000000000000000000000000AAAA',
            account='0x000000000000000000000000000000000000BABA',
            tokenId=4)], events)
    ...
    def test_erc721_transfer(self):
        ...
        self.assertEqual([TransferNonFungibleEvent(
            contract_address='0x000000000000000000000000000000000000AAAA',
...
class UniSwapV2Tests(unittest.TestCase):
    def test_uniSwapV2_newPair(self):
        ...
        pairCreated_event.processReceipt = MagicMock(return_value=[
            EventData(event='PairCreated',
                      args={
        ...
        events = te.get_transaction_events(ContractCategory.UNI_SWAP_V2_FACTORY, contract, receipt, block_hash)
        events = list(events)

        self.assertEqual([PairCreatedEvent(
            contract_address='0x000000000000000000000000000000000000AAAA',
            pair_address='0x0000000000000000000000000000000000000003',
            token0='0x0000000000000000000000000000000000000001',
            token1='0x0000000000000000000000000000000000000002')], events)
    ...
    def test_uniSwapV2Pair_mint(self):
        ...
        events = te.get_transaction_events(ContractCategory.UNI_SWAP_V2_PAIR, contract, receipt, block_hash)
        events = list(events)
    ...
    def test_uniSwapV2Pair_burn(self):
        ...
        self.assertEqual([
            BurnPairEvent(contract_address='0x000000000000000000000000000000000000AAAA',
    ...
    def test_uniSwapV2Pair_swap(self):
        ...
        self.assertEqual([
            SwapPairEvent(contract_address='0x000000000000000000000000000000000000AAAA',
                          src='0x0000000000000000000000000000000000000001',
                          dst='0x0000000000000000000000000000000000000002',
                          in0=2,
                          in1=3,
